...
%%-----------------------------------------------------------------------------
\usepackage{fontspec}
\setmainfont{times.ttf} % substitute with any font that exists on your system
\setsansfont{times.ttf} % substitute with any font that exists on your system
\setmonofont{times.ttf} % substitute with any font that exists on your system
