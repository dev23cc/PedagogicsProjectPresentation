...
%%-----------------------------------------------------------------------------
\usepackage{fontspec}
\setmainfont{GFS Didot.otf} % substitute with any font that exists on your system
\setsansfont{GFS Didot.otf} % substitute with any font that exists on your system
\setmonofont{GFS Didot.otf} % substitute with any font that exists on your system
