...
%%-----------------------------------------------------------------------------
\usepackage{fontspec}
\setmainfont{GFS Didot} % substitute with any font that exists on your system
\setsansfont{GFS Didot} % substitute with any font that exists on your system
\setmonofont{GFS Didot} % substitute with any font that exists on your system
...
\attachfile[icon=Paperclip,color=blue]{source.zip}{\textcolor{blue}{Project Source Code}
\end{document}
